...
public final class ERDesigner {
	...
	public static void main(String[] args)
		...
		JOptionPane.showMessageDialog(frame, "Please, Connect to database connection first!");
		JOptionPane.showMessageDialog(frame, "If you want to Connect the database, you can find this in Database menu bar!");
	}
}